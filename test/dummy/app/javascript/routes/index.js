...
export const rails_blob_representation_path = (...args) => pathFor(rails_blob_representation, ...args)
...
export const rails_direct_uploads_path = (...args) => pathFor(rails_direct_uploads, ...args)
...
export const rails_disk_service_path = (...args) => pathFor(rails_disk_service, ...args)
const rails_info = ["/rails/info(.:format)", ["format"], {}]
export const rails_info_url = (...args) => urlFor(rails_info, ...args)
export const rails_info_path = (...args) => pathFor(rails_info, ...args)
...
export const rails_info_properties_path = (...args) => pathFor(rails_info_properties, ...args)
...
export const rails_info_routes_path = (...args) => pathFor(rails_info_routes, ...args)
const rails_mailers = ["/rails/mailers(.:format)", ["format"], {}]
export const rails_mailers_url = (...args) => urlFor(rails_mailers, ...args)
export const rails_mailers_path = (...args) => pathFor(rails_mailers, ...args)
...
export const rails_service_blob_path = (...args) => pathFor(rails_service_blob, ...args)
const root = ["/", [], {}]
export const root_url = (...args) => urlFor(root, ...args)
export const root_path = (...args) => pathFor(root, ...args)
...
export const update_rails_disk_service_path = (...args) => pathFor(update_rails_disk_service, ...args)
